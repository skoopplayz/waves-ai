...
sendMsg.addEventListener("click",()=>{
  ...
  if(isFetching){abortController.abort();abortController=null;isFetching=false;sendMsg.innerHTML='<i aria-label="Enter Button" class="fas fa-arrow-up"></i>';document.querySelectorAll(".thinking-indicator").forEach(x=>x.remove());appendMessage("Request Cancelled.","ai");showToast("Request Cancelled.","info");return}
